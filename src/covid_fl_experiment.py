...
df = pd.read_csv(DATASETS_DIR / "covid.csv", low_memory=False)
...
print("COVID FL cleaned dataset shape:", X_scaled.shape)
print("COVID FL target distribution:")
